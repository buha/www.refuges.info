...
$vue->css           [] = $config['url_chemin_leaflet'].($config['debug']?'src/':'dist/').'leaflet.css?'.filemtime($config['chemin_leaflet'].'leaflet.css');
$vue->java_lib_foot [] = $config['url_chemin_leaflet'].($config['debug']?'src/':'dist/').'leaflet.js?' .filemtime($config['chemin_leaflet'].'leaflet.js');
