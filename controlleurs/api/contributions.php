...
switch ($req->format) {
    case 'json':
        include($wri['chemin_vues'].'api/contributions.vue.json');
        break;
    case 'xml':
        include($wri['chemin_vues'].'api/contributions.vue.xml');
        break;
    case 'csv':
        include($wri['chemin_vues'].'api/contributions.vue.csv');
        break;
    case 'rss':
        include($wri['chemin_vues'].'api/contributions.vue.rss');
        break;
    default:
        include($wri['chemin_vues'].'api/contributions.vue.json');
        break;
