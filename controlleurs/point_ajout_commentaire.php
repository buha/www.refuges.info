...
if (!$point->erreur)
{
    ...
    if ($_POST['action']!="") 
    {
        ...
        else
        {
            ...
            if (isset ($wri['censure']) && preg_match ('/'.$wri['censure'].'/i', retrait_accents ($commentaire->texte)))
            ...
            if ($point->id_point_type == $wri['id_batiment_en_montagne'])
    ...
    $vue->lien_forum_point=$wri['forum_refuge'].$info_forum_point->topic_id;
}
