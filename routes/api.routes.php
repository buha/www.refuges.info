...
switch ($cible) {
    case 'bbox': case 'point': case 'massif':
        include($wri['chemin_controlleurs'].'api/points.php');
        break;
    case 'contributions':
        include($wri['chemin_controlleurs'].'api/contributions.php');
        break;
    case 'polygones':
        include($wri['chemin_controlleurs'].'api/polygones.php');
        break;
    case 'doc':
        // Des fichiers html ou css simples, pas besoin d'un controler pour faire "include"
        if ($controlleur->url_decoupee[2] == "")
            include($wri['chemin_vues'].'api/doc/index.html');
        else 
            include($wri['chemin_vues'].'api/doc/'.$controlleur->url_decoupee[2]);
